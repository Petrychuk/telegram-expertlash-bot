...
def _start_scheduler():
    """
    Внутренний «крон». Запускает все джобы из tasks.py по интервалу. Управляется переменными окружения:
    ...
    if not enabled:
        ...
        return
    interval_min = int(os.getenv("CRON_INTERVAL_MIN", "1440"))  # по умолчанию раз в сутки
    def loop():
